# app/plugins/discordvoice/main.py
import os
from fastapi import WebSocket, WebSocketDisconnect
from fastapi.responses import HTMLResponse
from app.baseplugin import BasePlugin

class DiscordVoicePlugin(BasePlugin):
    def __init__(self, name: str, prefix: str, bus, subscribed_topics: list, **kwargs):
        super().__init__(name, prefix, bus, subscribed_topics, **kwargs)
        self.subscribed_topics = ["discord:voice_state"]
